...
# Joint names in sdk / robot / mujoco order
...
# Joint names in policy / isaacsim order
POLICY_JOINT_NAMES = [
    "left_shoulder_pitch_joint",
    "right_shoulder_pitch_joint",
    "waist_pitch_joint",
...
# Mujoco
MJCF_FILE = os.path.join(_HERE, "g1_29dof", "scene_29dof.xml")
SIM_DT = 0.005
DECIMATION = 4
...
# GLFW keycodes for numpad digits.
KEY_KP_2 = 322
KEY_KP_4 = 324
KEY_KP_5 = 325
KEY_KP_6 = 326
...
# NOTE: All the parameters are definde in policy order
HISTORY_LENGTH = 8
